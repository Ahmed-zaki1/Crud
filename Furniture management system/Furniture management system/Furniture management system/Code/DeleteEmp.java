...
import javax.swing.*;
import java.sql.*;
public class DeleteEmp extends Furniture implements ActionListener, ItemListener
 {
 	public Choice desgn;
 	Choice dept;
	public DeleteEmp()
	 ...
	 public void actionPerformed(ActionEvent ae)
        	{
				...
				if(ae.getSource()==save)
				{
						...
						try
						{
String str1="Delete from Employee where EID='"+dept.getSelectedItem()+"'";
...
JOptionPane.showMessageDialog( this,"Record Successfully Deleted","Delete",JOptionPane.INFORMATION_MESSAGE);
							 ...
							 cleartext();
st.executeUpdate("insert into EmployeeDelete values('"+dept.getSelectedItem()+"')");
