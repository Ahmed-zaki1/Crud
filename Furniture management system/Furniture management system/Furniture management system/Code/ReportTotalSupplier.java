...
import java.sql.*;
	 ...
	 public class ReportTotalSupplier extends Furniture implements ActionListener
	{
 		String h[]={"Suuplier ID","SuppName","Address","PhoneNo"};
		int cnt=0,i=0;
		//Label l1;
		JScrollPane jpane;
		JTable t1;
		...
		public ReportTotalSupplier()
		{
			...
			while(rs.next())
			{
				record1[i][0]=rs.getString("SupplierID");
				record1[i][1]=rs.getString("SuppName");
				record1[i][2]=rs.getString("Address");
